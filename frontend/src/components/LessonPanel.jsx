...
export default function LessonPanel({ lesson, loading, mode }) {
    ...
    <main className="lesson-panel card">
      <div className="lesson-header">
        <div>
          ...
          <h1>{lesson.title}</h1>
          {lesson.isCapstonePart ? <span className="badge persistence">Persistent Project Workspace</span> : null}
        </div>
      ...
      <section className="lesson-content card-soft">
        ...
        {mode === "real-world" ? <div className="real-world-banner">🌍 {lesson.realWorldScenario}</div> : null}
